...
prolist = ['isis']
for pro in prolist:
    df1 = pd.read_csv('../data/balancedata/java/netbeans_link_process.csv')
    df2 = pd.read_csv('../data/balancedata/java/netbeans_link.csv')
    ...
    res.to_csv('../data/netbeans_link.csv')
    print(res.columns)
